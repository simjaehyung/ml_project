 ...
 * Next.js 프로젝트의 src/types/api.ts 로 복사해서 사용.
 *
 * 규칙:
...
// ══════════════════════════════════════════════════════════════════
// SECTION 6-2: 예약 전체 분석 (매니저 상세 페이지)
// ══════════════════════════════════════════════════════════════════
...
export interface BookingAnalysis {
  ...
  discount_rate: number | null;
  confidence: ConfidenceLevel;
  top_risk_factors: RiskFactor[];   // 10개
  flexi_rationale: string;
  estimated_loss_if_cancel: number;
  estimated_flexi_discount: number;
}
